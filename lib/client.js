	...
	factory: (require) => {
		...
		function RedoIcon({ size = 14 }) {
			return (0, react_jsx_runtime.jsxs)("svg", {
				...
				strokeWidth: "1.4",
				"aria-hidden": "true",
				children: [(0, react_jsx_runtime.jsx)("path", { d: "M12.5 7.2A5.2 5.2 0 1 0 13.2 10" }), (0, react_jsx_runtime.jsx)("path", { d: "M12.5 3.2v4h-4" })]
			});
		}
		...
		var turn_card_module_css_default = {
			...
			"confirm": "turn-card-module_confirm",
			"confirmActions": "turn-card-module_confirmActions",
			"confirmBody": "turn-card-module_confirmBody",
			"confirmCancel": "turn-card-module_confirmCancel",
			"confirmOk": "turn-card-module_confirmOk",
			...
			"undoWrap": "turn-card-module_undoWrap",
		...
		function TurnCard(props) {
			...
			const confirmWrap = (0, react.useRef)(null);
			...
			const undoFiles = (0, react.useMemo)(() => allFiles.map((file) => ({
				path: file.path,
			...
			const dismissConfirm = (0, react.useCallback)(() => {
				setUndoState((current) => current === "confirmUndo" ? "idle" : current === "confirmRedo" ? "done" : current);
			}, []);
			(0, react.useEffect)(() => {
				if (!confirming) return;
				const onPointer = (event) => {
					if (confirmWrap.current?.contains(event.target)) return;
					dismissConfirm();
				};
				const onKey = (event) => {
			...
			const firstActionError = (result) => {
				if (result === null) return "host API unavailable";
				if (typeof result.error === "string" && result.error !== "") return result.error;
				return (result.results?.find((entry) => typeof entry.error === "string" && entry.error !== ""))?.error ?? null;
			};
			...
			const redoTurn = (0, react.useCallback)(() => {
				setActionError(null);
				setUndoState("redoing");
				(async () => {
					const result = await hostCall("redo", {
						cwd,
						files: undoFiles
					});
					if (result !== null && result.ok) {
			...
			const onUndoClick = (0, react.useCallback)(() => {
				...
				children: [(0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						(0, react_jsx_runtime.jsxs)("div", {
							...
							children: [hostReady && (0, react_jsx_runtime.jsxs)("div", {
								ref: confirmWrap,
								className: turn_card_module_css_default.undoWrap,
								children: [(0, react_jsx_runtime.jsxs)("button", {
									type: "button",
									className: turn_card_module_css_default.undo,
									disabled: undoState === "busy" || undoState === "redoing",
									"aria-haspopup": "dialog",
									"aria-expanded": confirming,
									title: undoState === "error" ? actionError ?? t("card.undoFailedTitle") : undoState === "redoError" ? actionError ?? t("card.redoFailedTitle") : undoState === "done" || undoState === "confirmRedo" ? t("card.redoTitle") : t("card.undoTitle"),
									onClick: onUndoClick,
									children: [
										undoState === "busy" ? t("card.undoing") : undoState === "redoing" ? t("card.redoing") : undoState === "error" ? t("card.undoFailed") : undoState === "redoError" ? t("card.redoFailed") : undoState === "done" || undoState === "confirmRedo" ? t("card.redo") : t("card.undo"),
										(undoState === "idle" || undoState === "error" || undoState === "confirmUndo" || undoState === "busy") && (0, react_jsx_runtime.jsx)(UndoIcon, {}),
										(undoState === "done" || undoState === "redoError" || undoState === "confirmRedo" || undoState === "redoing") && (0, react_jsx_runtime.jsx)(RedoIcon, {})
									]
								}), confirming && (0, react_jsx_runtime.jsxs)("div", {
									className: turn_card_module_css_default.confirm,
									role: "dialog",
									"aria-modal": "false",
									children: [(0, react_jsx_runtime.jsx)("p", {
										className: turn_card_module_css_default.confirmBody,
										children: undoState === "confirmRedo" ? t("card.redoConfirmBody") : t("card.undoConfirmBody")
									}), (0, react_jsx_runtime.jsxs)("div", {
										className: turn_card_module_css_default.confirmActions,
										children: [(0, react_jsx_runtime.jsx)("button", {
											type: "button",
											className: turn_card_module_css_default.confirmCancel,
											onClick: dismissConfirm,
											children: t("card.confirmCancel")
										}), (0, react_jsx_runtime.jsx)("button", {
											type: "button",
											className: turn_card_module_css_default.confirmOk,
											onClick: undoState === "confirmRedo" ? redoTurn : undoTurn,
											children: undoState === "confirmRedo" ? t("card.redoConfirm") : t("card.undoConfirm")
										})]
									})]
								})]
							}), (0, react_jsx_runtime.jsx)("button", {
